...
Am implementat această cerință pe baza evenimentului pointer, utilizând [setPointerCapture](https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture) pentru a capta poziția mouse-ului în afara BrowserWindow, și funcționează perfect.
