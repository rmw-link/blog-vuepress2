...
Olen toteuttanut tämän vaatimuksen osoittimen tapahtuman perusteella käyttämällä [setPointerCapture-ohjelmaa](https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture) hiiren sijainnin kaappaamiseksi BrowserWindow-ikkunan ulkopuolella, ja se toimii täydellisesti.
