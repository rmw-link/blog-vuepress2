...
Tento požadavek jsem implementoval na základě události ukazatele pomocí [setPointerCapture](https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture) pro zachycení polohy myši mimo okno BrowserWindow a funguje to perfektně.
